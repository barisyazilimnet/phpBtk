    ...
    <table width="760" style="border-collapse:collapse;">
        ...
        if ($query->rowCount()) {
            foreach ($order_numbers as $order_number) {
                ...
                $query->execute([0, $order_number->order_number]);
                        ...
                        <td colspan="2" style="border-bottom:1px dashed #ccc">
                            <table style="border-collapse:collapse; text-align:left; width:750px; margin-left:5px;">
                                <tr style="height:30px;">
                                    ...
                                    <td style="text-align: left; width:175px"><?php echo date("d.m.Y", $order->order_date); ?></td>
                                    ...
                                    <td width="25">
                                        <a href="index.php?page_code_outside=0&page_code_inside=108&order_number=<?php echo $order_number->order_number  ?>">
                                            <img src="../img/Sil20x20.png" alt="Sil20x20" />
                                        </a>
                                    </td>
                                    <td width="25">
                                        <a href="index.php?page_code_outside=0&page_code_inside=108&order_number=<?php echo $order_number->order_number ?>" style="color:#646464">
                                            Sil
                                        </a>
                                    </td>
                                    <td width="25">
                                        <a href="index.php?page_code_outside=0&page_code_inside=104&order_number=<?php echo $order_number->order_number  ?>">
                                            <img src="../img/DokumanKirmiziKalemli20x20.png" alt="DokumanKirmiziKalemli20x20" />
                                        </a>
                                    </td>
                                    <td width="50">
                                        <a href="index.php?page_code_outside=0&page_code_inside=104&order_number=<?php echo $order_number->order_number ?>" style="color:#646464">
                                            Detay
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <td colspan="8" style="text-align: center;">
                        <div class="paging_container">
                            ...
                            <div class="paging_container_inside_number_container">
                                <?php
                                if ($paging > 1) {
                                    echo '<span class="paging_passive"><a href="index.php?page_code_outside=0&page_code_inside=101&paging=1"><<</a></span>';
                                    echo '<span class="paging_passive"><a href="index.php?page_code_outside=0&page_code_inside=101&paging=' . ($paging - 1) . '"><</a></span>';
                                }
                                for ($page_index = $paging - 2; $page_index <= $paging + 2; $page_index++) {
                                    if ($page_index > 0 and $page_index <= $total_page_number) {
                                        if ($page_index == $paging) {
                                            ...
                                            echo '<span class="paging_passive"><a href="index.php?page_code_outside=0&page_code_inside=101&paging=' . $page_index . '">' . $page_index . '</a></span>';
                                        }
                                    }
                                }
                                if ($paging != $total_page_number) {
                                    echo '<span class="paging_passive"><a href="index.php?page_code_outside=0&page_code_inside=101&paging=' . ($paging + 1) . '">></a></span>';
                                    echo '<span class="paging_passive"><a href="index.php?page_code_outside=0&page_code_inside=101&paging=' . $total_page_number . '">>></a></span>';
                                }
                                ?>
                            </div>
                        </div>
            ...
            <tr>
                <td colspan="2">
                    <table style="border-collapse:collapse; text-align:left; width:750px;">
                        <tr>
                            <td>&nbsp;&nbsp;Kayıtlı Yeni Sipariş Bulunmamaktadır.</td>
                        </tr>
                    </table>
                </td>
            </tr>
