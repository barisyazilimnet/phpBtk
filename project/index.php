            ...
            <td>
                <table width="1065" style="margin: 0 auto; border-collapse:collapse; background-color:#f9f9f9">
                    ...
                    <tr height="30">
                        ...
                        <?php } else { ?>
                            <td><a href="index.php?page_code=21" style="color:#646464;">Üye ol</a></td>
                        <?php } ?>
                        <td>&nbsp;</td>
                    ...
                    <tr height="30">
                        ...
                        <?php } else { ?>
                            <td><a href="index.php?page_code=30" style="color:#646464;">Giriş Yap</a></td>
                        <?php } ?>
                        <td>&nbsp;</td>
