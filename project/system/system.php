...
function seo($contents)
{
    ...
    return trim(preg_replace("/-+/", "-", preg_replace("/[^a-z0-9]./", "-", mb_strtolower(str_replace($turkish, $english, trim($contents)), "UTF-8"))), "-");
}
...
$page = [
    ...
    "admin_panel_inside" => array(
        ...
        "admin_users.php",
        "admin_users_add.php", //70
        "admin_users_add_result.php",
        "admin_users_add_result_OK.php",
        "admin_users_add_result_ERROR.php",
        "admin_users_update.php",
        "admin_users_update_result.php", //75
        "admin_users_update_result_OK.php",
        "admin_users_update_result_ERROR.php",
        "admin_users_delete_result.php",
        "admin_users_delete_result_OK.php",
        "admin_users_delete_result_ERROR.php", //80
        "users.php",
        "users_delete_result.php",
        "users_delete_result_OK.php",
        "users_delete_result_ERROR.php",
        "comments.php", //85
        "comments_delete_result.php",
        "comments_delete_result_OK.php",
        "comments_delete_result_ERROR.php",
        "products.php",
        "products_add.php", //90
        "products_add_result.php",
        "products_add_result_OK.php",
        "products_add_result_ERROR.php",
        "products_update.php",
        "products_update_result.php", //95
        "products_update_result_OK.php",
        "products_update_result_ERROR.php",
        "products_delete_result.php",
        "products_delete_result_OK.php",
        "products_delete_result_ERROR.php", //100
        "orders.php",
        "completed_orders.php",
        "completed_order_detail.php",
        "order_detail.php",
        "order_shipping_code_result.php", //105
        "order_shipping_code_result_OK.php",
        "order_shipping_code_result_ERROR.php",
        "order_delete_result.php",
        "order_delete_result_OK.php",
        "order_delete_result_ERROR.php", //110
        "payment_notification.php",
        "payment_notification_delete_result.php",
        "payment_notification_delete_result_OK.php",
        "payment_notification_delete_result_ERROR.php",
    )
];
